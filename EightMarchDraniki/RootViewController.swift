...
class RootViewController: UIViewController, UIPageViewControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.pageViewController!.gestureRecognizers.forEach { $0.isEnabled = false }
    }
    ...
    var modelController: ModelController {
        ...
        if _modelController == nil {
            ...
            _modelController?.turnToNext = { [weak self] in
                self?.toNextQuestion()
            }
        }
    ...
    func toNextQuestion() {
        ...
        guard let nextViewController = self.modelController.pageViewController(self.pageViewController!, viewControllerAfter: currentViewController ) else {
            if modelController.lastAnswered == SharedSource.shared.data.count - 1 {
                performSegue(withIdentifier: "ShowGift", sender: nil)
            }
            return
        }
